...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btnDialogInfo.setStatusTip(
            QCoreApplication.translate("MainWindow", u"Exemplo de caixa de di\u00e1logo de \"Informa\u00e7\u00e3o\"", None))
        ...
        self.label.setText(QCoreApplication.translate("MainWindow",
                                                      u"<html><head/><body><p align=\"center\"><span style=\" font-size:11pt; font-weight:700; color:#0277bd;\">Pr\u00e9-definidos</span></p></body></html>",
                                                      None))
        # if QT_CONFIG(statustip)
        ...
        # if QT_CONFIG(statustip)
        self.lblFontesCores.setStatusTip(
            QCoreApplication.translate("MainWindow", u"Utilize os bot\u00f5es \"Fontes\" e \"C\u00f4res\" para me estilizar", None))
        # endif // QT_CONFIG(statustip)
        self.lblFontesCores.setText(
            QCoreApplication.translate("MainWindow", u"<html><head/><body><p align=\"center\">Eu sou<br>um simples<br>texto.</p></body></html>", None))
        # if QT_CONFIG(statustip)
        ...
        # if QT_CONFIG(statustip)
        self.btnExcluirArquivo.setStatusTip(
            QCoreApplication.translate("MainWindow", u"Exclui um arquivo de texto no diret\u00f3rio do programa", None))
        # endif // QT_CONFIG(statustip)
        ...
        # if QT_CONFIG(statustip)
        self.btnPastaAtual.setStatusTip(
            QCoreApplication.translate("MainWindow", u"Caminho da pasta de onde o programa est\u00e1 sendo executado", None))
        # endif // QT_CONFIG(statustip)
        ...
        # if QT_CONFIG(statustip)
        self.btnExcluirPasta.setStatusTip(
            QCoreApplication.translate("MainWindow", u"Exclui as pastas criadas atrav\u00e9s do dois bot\u00f5es acima, caso existam.", None))
        # endif // QT_CONFIG(statustip)
        ...
        # if QT_CONFIG(statustip)
        self.btnRandSample.setStatusTip(
            QCoreApplication.translate("MainWindow", u"Escolhe aleatoriamente mais de um elemento de uma lista sem repetir elementos.", None))
        # endif // QT_CONFIG(statustip)
        ...
        # if QT_CONFIG(statustip)
        self.btnParaTestes.setStatusTip(
            QCoreApplication.translate("MainWindow", u"Bot\u00e3o sem fun\u00e7\u00e3o espec\u00edfica, apenas para testes diversos", None))
        # endif // QT_CONFIG(statustip)
        ...
        self.label_3.setText(QCoreApplication.translate("MainWindow",
                                                        u"<html><head/><body><p><span style=\" font-size:28pt; font-weight:700; color:#0277bd;\">Python Examples</span></p></body></html>",
                                                        None))
